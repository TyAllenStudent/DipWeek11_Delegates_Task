...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = @"C:\Diploma-at-28-April\OOP\New folder\DipWeek11_Delegates_Task\Files\data.csv";  // change to appropriate path
        private string _tsvPath = @"C:\Diploma-at-28-April\OOP\New folder\DipWeek11_Delegates_Task\Files\data.tsv";  // change to appropriate path

        private string _writeFile = @"C:\Diploma-at-28-April\OOP\New folder\DipWeek11_Delegates_Task\Files\newData.tsv";  // change to appropriate path
